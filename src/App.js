  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route path='/ListMovie' element={<ListMovie movies={movies} search={search} rate={rate} setMovies={setMovies} setSearch={setSearch} setRate={setRate}/>}/>
